...
| readonly        | Readonly mode, cannot add, delete, configure.                                                                                                                                                                                            | boolean                                                                  |          | -          |
...
| undoRedoTool    | undo and redo                                                                                                                                                                                                                            | boolean \| {hidden?: boolean, max?: number}                              | -        | false      |
| zoomTool        | zoom                                                                                                                                                                                                                                     | boolean \| {hidden?: boolean, min?: number, max?: number, step?: number} | -        | false      |
...
| :--- | :---------- | :--------------------------------------------------- |
| redo | Redo        | () => number \| undefined                            |
| undo | Undo        | () => number \| undefined                            |
| zoom | Zoom        | (type: 'smaller' \| 'bigger') => number \| undefined |
